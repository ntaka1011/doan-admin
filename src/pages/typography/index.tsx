  ...
  return (
    <Box sx={{ width: "100%" }}>
      ...
      <Box sx={{
        ...
        <Button variant="contained" onClick={() => router.push('/typography/add')}>Create Product</Button>
      </Box>
      <Paper sx={{ width: "100%", mb: 2 }}>
        <TableContainer>
          ...
          >
            ...
            />
            {rows?.slice(page.page * page.page_size, page.page * page.page_size + page.page_size).map((row: Product) => {
              ...
              return (
                ...
                >
                  ...
                  <TableCell align='right'>{row.quantity < 1 ? <Box sx={{
                    display: "flex",
                    alignItems: "center",
                    height: "40px",
                    ...
                    borderRadius: "999999px",
                    color: "#ff8e7c",
                  }}>Active</Box>}</TableCell>
                  <TableCell align='center'>
                    <Button variant="contained" sx={{ marginRight: "10px" }} onClick={() => router.push(`/typography/${row.slug}/edit`)} color={"info"}>
                      Edit
                    </Button>
