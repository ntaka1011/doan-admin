...
const Navigation = (props: Props) => {
  ...
  console.log("🚀 ~ file: index.tsx:61 ~ Navigation ~ beforeVerticalNavMenuContent:", beforeVerticalNavMenuContent)
  ...
  const scrollMenu = (container: any) => {
    console.log("🚀 ~ file: index.tsx:89 ~ scrollMenu ~ container:", container)
